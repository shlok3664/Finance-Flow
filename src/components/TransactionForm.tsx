...
import { Categories, SuggestedCategory } from '../types';
...
interface TransactionFormProps {
  ...
  setSuggestedCategory: (value: SuggestedCategory | null) => void;
    ...
    <div className={`${cardClass} rounded-2xl shadow-xl p-6 mb-8 border`}>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className={`block text-sm font-semibold ${textClass} mb-2`}>Amount ({currencySymbol})</label>
            <input
              type="number"
              value={amount}
        ...
        {suggestedCategory && suggestedCategory.category_key !== 'error' && (
          <div className={`p-3 rounded-xl bg-purple-100 ${darkMode ? 'bg-purple-900/50' : ''} border border-purple-300 text-sm`}>
            ...
            <p className="mt-1 flex items-center justify-between">
              <span className={darkMode ? 'text-purple-200' : ''}>
